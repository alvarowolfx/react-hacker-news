# React Hacker News
Aplicação desenvolvida com o intuito de ensinar a criar projetos usando React usando a CLI do time do Facebook, a [create-react-app](https://github.com/facebookincubator/create-react-app).
